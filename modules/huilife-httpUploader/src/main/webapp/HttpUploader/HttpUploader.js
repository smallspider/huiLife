...
function HttpUploaderMgr()
{
	...
	this.Config = {
		...
		, "UrlCreate"		: "http://localhost:8080/HttpUploader5ChrUtf8MySQL/db/ajax_create.jsp"
	...
	{
		$("#pnl-head").html('<a href="'+_this.Config["SetupPath"]+'" target="_blank">检查到您未安装控件，请先安装</a>');
	};
